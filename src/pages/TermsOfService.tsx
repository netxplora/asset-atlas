...
export default function TermsOfService() {
  const { data: page, isLoading } = useCmsPageBySlug("terms-of-service");
    ...
    <PublicLayout>
      <section className="relative min-h-[320px] flex items-center">
        <div className="absolute inset-0">
          <img src={heroLegal} alt="Terms of Service" className="w-full h-full object-cover" width={1920} height={640} />
